export const historicalPlaces = [
  {
    ...
    location: "China",
    time: "Spring (April to May) and Autumn (September to November)",
    ...
    significant:
      "The longest wall in the world, with watchtowers and fortifications dating back to the Ming Dynasty.",
    image:
      "https://cdn-imgix.headout.com/media/images/5b6b5c4b44633621ad74cc44800b836c-great%20wall%20of%20china.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 2,
    name: "The Colosseum",
    ...
    significant:
      "The world's largest amphitheater, famous for gladiator contests and public spectacles.",
    image:
  ...
  },
  {
    ...
    name: "Machu Picchu",
    location: "Cusco, Peru",
    time: "May to October when the weather is dry",
    duration: "At least a full day",
    description:
    ...
    significant:
      "An ancient Inca site with impressive engineering and architecture that has stood the test of time.",
    image:
      "https://cdn-imgix.headout.com/media/images/3e8cfb37a2b578b85b3eb0e65af9b68c-Machu%20Picchu%20Peru.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 4,
    name: "Pyramids of Giza",
    location: "Cairo, Egypt",
    time: "Winter (November to February)",
    duration: "At least half a day",
    description:
    ...
    significant:
      "Colossal structures built over 4,500 years ago without modern-day technology.",
    image:
      "https://cdn-imgix.headout.com/media/images/d44b6b387bab5e7e6517648382962a6c-20881-hurghada-from-hurghada---full-day-trip-to-cairo-by-plane-01.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 5,
    name: "The Taj Mahal",
    ...
    significant:
      "A masterpiece of Mughal architecture with intricate calligraphy, marble carvings, and floral designs.",
    image:
      "https://cdn-imgix.headout.com/media/images/624a71220e46309b910944143be7b344-Taj%20Mahal.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 6,
    name: "Ma'an Governorate",
    location: "Jordan",
    time: "Spring (March to May) and Autumn (September to November)",
    duration: "Full day",
    description:
    ...
    significant:
      "A hidden city with intricate rock-cut architecture and a water conduit system, surrounded by canyons and rock formations.",
    image:
      "https://cdn-imgix.headout.com/media/images/289d569d08bb6b63d6cd48141c77dc21-Ma'an%20Governorate%20Jordan.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 7,
    name: "The Acropolis",
    location: "Athens, Greece",
    time: "Spring (April to June) and Autumn (September to November)",
    duration: "3 Hours",
    description:
    ...
    significant:
      "A citadel with iconic structures including the Parthenon, the Temple of Athena Nike, and the Erechtheion, symbolizing ancient Greece's cultural and architectural achievements.",
    image:
      "https://cdn-imgix.headout.com/blog-content/image/b0c81fcd7080c1ca794e72e62ebb5450-AdobeStock_83450730.jpeg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 8,
    name: "Angkor Wat",
    ...
    significant:
      "One of the largest religious monuments in the world, built in honor of the Hindu god Vishnu.",
    image:
      "https://cdn-imgix.headout.com/media/images/77f4ceaa77ace47fee823255a0640d60-Angkor%20Wat%20Cambodia.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 9,
    name: "The Alhambra",
    ...
    time: "November to February",
    duration: "Spring (April to May) and Autumn (September to October)",
    description:
    ...
    significant:
      "A palace and fortress complex from the Nasrid Dynasty, which fell to the King Ferdinand and Isabel of Castille during the Spanish Inquisition.",
    image:
      "https://cdn-imgix.headout.com/media/images/4ce000ac05e2f77ea3d27ca99f189227-Alhambra%20Tickets%20%26%20Tours.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 10,
    ...
    significant:
      "Built during the Ming Dynasty in the 15th century, the Forbidden City served as the imperial palace for successive Chinese emperors for over 500 years.",
    image:
      "https://cdn-imgix.headout.com/media/images/c4c838cd3bc53040b8e6581cbcce4f72-The%20Forbidden%20City%20Beijing.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 11,
    ...
    significant:
      "One of the finest and best preserved examples of Baroque architecture.",
    image:
      "https://cdn-imgix.headout.com/media/images/00a87210d0b9efdc10c1230b916c105f-269-paris-paris--palace-of-versailles-01.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 12,
    ...
    significant:
      "The political and economic center of ancient Rome, with iconic structures including the Temple of Saturn, the Arch of Titus, and the Basilica of Maxentius.",
    image:
      "https://cdn-imgix.headout.com/media/images/a5ac022697961c6a814da60964462bb3-21451-rome-colosseum--roman-forum-and-palatine-mountain-guided-tour---optional-arena-access-08.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 13,
    name: "Hagia Sophia",
    ...
    significant:
      "A former Byzantine church and Ottoman mosque with exquisite architecture, mosaics, and frescoes, showcasing Turkey's rich cultural heritage.",
    image:
      "https://cdn-imgix.headout.com/media/images/3564ee70723666aeeba049d68f0e7071-21306-istanbul-full-day-istanbul-old-city-tour-08.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 14,
    ...
    significant:
      "The Tower of London is now a museum that now houses a lot of the medieval torture devices. A visit will give you an understanding of the punishments meted out in medieval England.",
    image:
      "https://cdn-imgix.headout.com/media/images/da38e4fc9f622731b1ca4b62ab54e4a3-Tower%20of%20London%20white%20tower.jpg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
  {
    id: 15,
    name: "The Pantheon",
    ...
    significant:
      "Its most distinctive feature is its massive dome, which remains the largest unreinforced concrete dome ever constructed.",
    image:
      "https://cdn-imgix.headout.com/media/images/7108125a447cdbdbf9d1d5f9598d198c-Rome%20Pantheon.jpeg?fm=pjpg&auto=compress&w=1100&h=750&crop=faces&fit=min",
  },
];
